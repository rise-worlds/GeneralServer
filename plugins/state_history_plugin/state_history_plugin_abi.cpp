    ...
    "structs": [
        ...
        },
        {
            "name": "block_header", "fields": [
                ...
                { "name": "enable_standby_schedule", "type": "bool" },
                { "name": "standby_schedule_block_num", "type": "uint32?" }
            ]
        },
        {
        ...
        },
        {
            "name": "global_property_v1", "fields": [
                ...
                { "type": "producer_schedule", "name": "standby_schedule" },
                { "type": "bool", "name": "enable_standby_schedule" },
                { "type": "uint32?", "name": "standby_schedule_block_num" }
            ]
        },
        {
