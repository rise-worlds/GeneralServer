...
inline uint64_t       ship_magic(uint32_t version) { return N(ship).to_uint256_t().low_64_bits() | version; }
inline bool           is_ship(uint64_t magic) { return (magic & 0xffff'ffff'0000'0000) == N(ship).to_uint256_t().low_64_bits(); }
