...
// using namespace potato::chain::plugin_interface;
...
namespace potato
{
    ...
    // using potato::chain::sha256_less;
    // using potato::chain::transaction_id_type;
    using fc::time_point;
    ...
    */
    ...
    bool connection::process_next_message(uint32_t message_length)
    {
        try
        {
            ...
            //     if (!my_impl->sync_master->syncing_with_peer())
            //     { // guard against peer thinking it needs to send us old blocks
            //         uint32_t lib = 0;
