...
FC_REFLECT(potato::go_away_message, (reason)(node_id))
FC_REFLECT(potato::time_message, (org)(rec)(xmt)(dst))
// FC_REFLECT(potato::notice_message, (known_trx)(known_blocks))
// FC_REFLECT(potato::request_message, (req_trx)(req_blocks))
// FC_REFLECT(potato::sync_request_message, (start_block)(end_block))
