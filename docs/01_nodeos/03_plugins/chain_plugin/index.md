...
Config Options for eosio::chain_plugin:
  ...
  --actor-denylist arg                 Account added to actor denylist (may 
                                        specify multiple times)
  --contract-allowlist arg              Contract account added to contract 
                                        allowlist (may specify multiple times)
  --contract-denylist arg              Contract account added to contract 
                                        denylist (may specify multiple times)
  --action-denylist arg                Action (in the form code::action) added
                                        to action denylist (may specify 
                                        multiple times)
  --key-denylist arg                   Public key added to denylist of keys 
                                        that should not be included in 
                                        authorities (may specify multiple 
                                        times)
  --sender-bypass-allowdenylist arg    Deferred transactions sent by accounts 
                                        in this list do not have any of the 
                                        subjective allowlist/denylist checks 
