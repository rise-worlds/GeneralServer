...
namespace eosio { namespace testing {
   ...
   class base_tester {
      public:
         ...
         void              open( fc::optional<chain_id_type> expected_chain_id, Lambda lambda );
   ...
   public:
      ...
      static unique_ptr<controller> create_validating_node(controller::config vcfg, const genesis_state& genesis, bool use_genesis) {
         unique_ptr<controller> validating_node = std::make_unique<controller>(vcfg, genesis.compute_chain_id());
      ...
      bool validate() {
        ...
        validating_node = std::make_unique<controller>(vcfg, control->get_chain_id());
        validating_node->add_indices();
        validating_node->startup( []() { return false; } );
