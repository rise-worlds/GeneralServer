...
namespace eosio { namespace testing {
   ...
   void base_tester::open( fc::optional<chain_id_type> expected_chain_id, Lambda lambda ) {
      ...
      control.reset( new controller(cfg, *expected_chain_id) );
      control->add_indices();
      lambda();
      chain_transactions.clear();
