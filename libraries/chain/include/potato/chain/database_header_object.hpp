...
CHAINBASE_SET_INDEX_TYPE(potato::chain::database_header_object, potato::chain::database_header_multi_index)

FC_REFLECT(potato::chain::database_header_object, (version))
