#include <potato/chain/platform_timer_accuracy.hpp>
...
#define TIMER_STATS \
   ("min", bacc::min(samples))("max", bacc::max(samples))("mean", (int)bacc::mean(samples))("stddev", (int)sqrt(bacc::variance(samples)))
