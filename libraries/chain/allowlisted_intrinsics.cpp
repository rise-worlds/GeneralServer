...
namespace eosio { namespace chain {
   ...
   find_intrinsic( allowlisted_intrinsics_type& allowlisted_intrinsics, uint64_t h, const std::string& name )
   {
   ...
   find_intrinsic( const allowlisted_intrinsics_type& allowlisted_intrinsics, uint64_t h, const std::string& name )
   {
      auto itr = allowlisted_intrinsics.lower_bound( h );
      const auto end = allowlisted_intrinsics.end();
